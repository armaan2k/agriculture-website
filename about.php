...
<?php print_head("About", 0) ?>
	<body>
      ...
      <blockquote>
        ...
        <div>--- Climate Smart Agriculture Sourcebook, Section A1 - 1, <a href="http://www.fao.org">The Food and Agriculture Organization of the United Nations</a></div>
      </blockquote>
    </main>
